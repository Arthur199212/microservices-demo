...
func (c *paymentServiceClient) Charge(ctx context.Context, in *ChargeRequest, opts ...grpc.CallOption) (*ChargeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/services.payment.v1.PaymentService/Charge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PaymentService_Charge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/services.payment.v1.PaymentService/Charge",
	}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "services.payment.v1.PaymentService",
	...
	Metadata: "services/payment/v1/payment_service.proto",
}
