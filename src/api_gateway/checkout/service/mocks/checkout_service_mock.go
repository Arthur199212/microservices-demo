...
// Source: github.com/Arthur199212/microservices-demo/src/api_gateway/checkout/service (interfaces: CheckoutService)
...
import (
	...
	service "github.com/Arthur199212/microservices-demo/src/api_gateway/checkout/service"
...
func (m *MockCheckoutService) PlaceOrder(arg0 context.Context, arg1 service.CheckoutServiceArgs) (*checkoutv1.Order, error) {
	m.ctrl.T.Helper()
