...
// Source: github.com/Arthur199212/microservices-demo/src/shipping/shipping (interfaces: ShippingService)
...
func (m *MockShippingService) GetQuote(arg0 shipping.Address, arg1 []shipping.Product) (shipping.Quote, error) {
	m.ctrl.T.Helper()
...
func (m *MockShippingService) ShipOrder(arg0 shipping.Address, arg1 []shipping.Product) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ShipOrder", arg0, arg1)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockShippingServiceMockRecorder) ShipOrder(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ShipOrder", reflect.TypeOf((*MockShippingService)(nil).ShipOrder), arg0, arg1)
}
